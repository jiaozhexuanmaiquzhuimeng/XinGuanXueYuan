...
<div class="container">
			...
			<div class="collapse navbar-collapse" id="example-navbar-collapse">
				<ul class="nav navbar-nav" id="Nav">
					...
					<li><a href="" class="dropdown-toggle" data-toggle="dropdown" onclick="window.location.href='<%=request.getContextPath()%>/collegeServlet?method=SchoolProfilePage&table=td_college_introduction&title=introduction'">学院概况<span
					...
					<li><a href="#" onclick="window.location.href='<%=request.getContextPath()%>/educationServlet?method=EducationTeachingPage&table=td_education_major&title=major'">教务教学 <span class="nav-slider"></span><b
							class="caret"></b>
					</a>
					...
					<li><a href="#" onclick="window.location.href='<%=request.getContextPath()%>/rmstuServlet?method=RmstuPage&table=td_Rmstu_admissions&title=admissions'">招生就业<span class="nav-slider"></span><b
							class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li><a href="#" onclick="window.location.href='<%=request.getContextPath()%>/scienceServlet?method=SciencePage&table=td_science_management&title=management'">科研工作 <span class="nav-slider"></span><b
							class="caret"></b>
					</a>
					...
					<li><a href="#" onclick="window.location.href='<%=request.getContextPath()%>/stumanageServlet?method=StumanagePage&table=td_stumanage_stuwork&title=stuwork'">学生管理 <span class="nav-slider"></span><b
							class="caret"></b>
					</a>
					...
					<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="window.location.href='<%=request.getContextPath()%>/testServlet?method=TestPage&table=td_test_center&title=center'">实验教学<span
							class="nav-slider"></span><b class="caret"></b></a>
