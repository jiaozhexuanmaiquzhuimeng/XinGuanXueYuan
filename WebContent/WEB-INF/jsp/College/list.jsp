							...
							<nav aria-label="...">
								<ul class="pagination pagination-sm">
									<c:if test="${pageInfo.hasPrev }">
										<li><a
											href="<%=request.getContextPath()%>/collegeServlet?method=SchoolProfilePage&pageNo=${pageInfo.prevPage }&table=${table }"
									...
									<c:if test="${pageInfo.hasNext }">
										<li><a
											href="<%=request.getContextPath()%>/collegeServlet?method=SchoolProfilePage&pageNo=${pageInfo.nextPage }&table=${table }"
