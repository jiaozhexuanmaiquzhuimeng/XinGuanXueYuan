...
<body>
    ...
    <div id="content" class="container-fluid">
        ...
        <div class="container" style="padding: 0 0;">
            ...
            <p>
                <a href="<%=request.getContextPath()%>/userServlet?method=showTitle&creative=td_creative&graduate=td_education_stugraduate&Group=td_Group_dynamics&sciencework=td_science_management&studentwork=td_stumanage_stuwork&firstnews=td_firstnews&notice=td_notice&teachingwork=td_education_teach&imgTable=td_image" class="back-index">&lt; 返回首页</a>
            </p>
        </div>
