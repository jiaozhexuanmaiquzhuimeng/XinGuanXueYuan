...
public class RulesServlet extends HttpServlet {
	...
	public void RulesPage(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/indexOtherList/Rules.jsp").forward(request, response);
	}
