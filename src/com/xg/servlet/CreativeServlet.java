...
/**
 * @author Guozhen_Zhao
 * 创建时间：2018年5月7日  下午1:46:33
 * 备注：
 */
@WebServlet("/creativeServlet")
public class CreativeServlet extends HttpServlet {
	...
	public void CreativePage(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/indexOtherList/CreativeList.jsp").forward(request, response);
	}
