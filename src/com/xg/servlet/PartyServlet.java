...
public class PartyServlet extends HttpServlet {
	...
	public void PartyPage(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/indexOtherList/PartyList.jsp").forward(request, response);
	}
